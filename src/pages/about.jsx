...
const About = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-black bg-opacity-25 mb-4 p-4 ">
        <div className=" md:mx-32  text-white mt-16">
          <div className="">
            ...
            <div className=" mt-8 text-lg">
              <p className=" mt-4">
                <span className=" font-semibold text-2xl">Expertise :- </span>
              ...
              <p className=" mt-4">
                ...
                create solutions that are tailored to your specific needs and
                goals.
              </p>
              <p className=" mt-4">
                <span className=" font-semibold text-2xl ">
              ...
              <p className=" mt-4">
                ...
                Count on us to be there when you need us. We&apos;re committed
            ...
            <NavLink to="/contact">
              <button
                type="button"
                className=" mt-6 mx-4 px-2 py-2 border border-blue-400 dark:bg-cyan-700 rounded-lg"
              >
                Connect Now
              </button>
            </NavLink>
            <button
              type="button"
              className=" mt-6 px-2 py-2 border border-blue-800  rounded-lg"
            >
              Learn more
            </button>
            <div className=""></div>
